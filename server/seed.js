...
// The admin account is the one with real privileges, so it doesn't get the
// same hardcoded "password123" as the demo users — a password committed to
// source is a live credential the moment this seed ever touches a reachable
// database. Generated fresh on every run and printed once below.
...
const seedDatabase = async () => {
  try {
    ...
    console.log(`Admin Password: ${adminPassword}  (generated fresh — not stored anywhere, save it now)`);
    console.log("-------------------------------------------");
    console.log("Demo User Email: user@eventora.com (and alice/bob/charlie/... @eventora.com)");
